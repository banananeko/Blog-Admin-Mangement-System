...
insert into users (username, password, bpassword, avatar, fname, lname, birthday, description, isAdmin) VALUES
('username1', 'abc123', 'abc123', '', 'Abram', 'Goh', '2000-01-01', 'This is Abram!', 1),
('username2', 'efg456', 'efg456', '', 'Colton', 'Randall', '2000-02-02', 'I am Colton!', 1),
('username3', 'hij789', 'hij789', '', 'Olga', 'Hoxha', '2000-03-03', 'This is Olga!', 1),
('banananeko', 'klm100', 'klm100', '', 'Yiwei', 'Li', '2000-04-04', 'I am Yiwei!', 1),
('test', 'test', 'test', '', 'test', 'test', '2000-01-01', 'test', null);
...
-- select (u.*),( select count(*) from r where u.userId = r.userId) 
-- from users as u
-- left join recipes as r  on u.userId = r.userId 

-- select u.*, Count(r.userId) AS recipe_count
--     from users as u
--     left OUTER join recipes as r on u.userId = r.userId
-- 	GROUP BY u.userId
